package id.ac.poliban.mi.ghazi.roomwordssampleupdate;


import static id.ac.poliban.mi.ghazi.roomwordssampleupdate.MainActivity.EXTRA_DATA_ID;
import static id.ac.poliban.mi.ghazi.roomwordssampleupdate.MainActivity.EXTRA_DATA_UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.ghazi.roomwordssampleupdate.REPLY";
    public static final String EXTRA_REPLY_ID = "id.ac.poliban.mi.ghazi.roomwordssampleupdate.REPLY_ID";
